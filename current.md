...
| ID | Description |
|----|-------------|
| FR-02 | System shall search funding databases (Förderdatenbank, KfW, BAFA, EU sources) using semantic matching based on questionnaire inputs. |

**Display of relevant funding programs with estimated amounts and percentages**
| ID | Description |
|----|-------------|
| FR-03 | System shall display relevant funding programs with estimated amounts, percentage ranges (e.g., 30-80%), and program descriptions. |
